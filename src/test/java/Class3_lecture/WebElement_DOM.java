package Class3_lecture;

public class WebElement_DOM {
    /**
     * Always make new branch
     * git branch
     * than commit and push the branch .
     * once it is done, check the branch
     * once we are done, delete the branch from the local using, bit branch -d class2..... just delete it from the local machine and check with " git branch"
     * every website has head and body
     * entire code is in the body section.
     * DOM--> document object model...... which is
     * DOM is really important for us...as Selenium QA Enginer, we use DOM,....
     * DOM create our website.
     * Front end Code generates DOM and DOM Creates the website.
     * DOM is always  html document.
     * <html>
     *      <head>(Title, URL or details)</head>
     *      <body>(</body>
     *</html>
     *
     * <tag>---> Start of the tag
     *Tags name cannot have space.
     * </tag>---> end of the tag.......................e.g html, body, script, div, form, input, span,
     */
