...
public class HomeWork5_Sol {
     ...
     */
        ...
        public void areValuesDisplayedCorrect() {
            ...
            String lowBarTempVal = MyDriver.getDriver().findElement(By.xpath("//a[@class='day revealed']//span[@class='minTemp']")).getText();
            String lowNumTempVal = MyDriver.getDriver().findElement(By.xpath("(//span[@class='temp'])[1]")).getText();
            Assert.assertEquals(lowBarTempVal, lowNumTempVal, "The Low temperatures displayed are non Same");

            String highBarTempVal = MyDriver.getDriver().findElement(By.xpath("(//span[@class='maxTemp'])[1]")).getText();
            String highNumTempVal = MyDriver.getDriver().findElement(By.xpath("(//span[@class='arrow']/following::span[@class='temp'])[1]")).getText();
            Assert.assertEquals(highBarTempVal, highNumTempVal, "The High temperatures displayed are non Same");
